...
public class DataProcessing03 {
	...
	public static void main(String[] args) throws IOException {
		...
		for (String mail : mails) {
			List<String> lineStrings = WriteFile
					.readFileByLines("F:\\邮箱数据\\2016-7-30-2016-10-28\\非空记录\\"
							+ mail + ".txt");
			// 学校往来邮件
			...
			WriteFile.writeFileByLines(
					"F:\\邮箱数据\\2016-7-30-2016-10-28\\所有关系非空2.csv", out);
		}
	...
	private static List<String> getMails() {
		...
		String[] fileStrings = WriteFile
				.getFileName("F:\\邮箱数据\\2016-7-30-2016-10-28\\非空记录");
